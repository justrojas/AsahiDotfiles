# Generated by Powerlevel10k configuration wizard on 2024-09-13 at 16:28 EDT.
...
# slanted separators, blurred heads, blurred tails, 2 lines, dotted, left frame,
...
() {
  ...
  # Show Docker icon when inside a Docker container
  if [ -f /.dockerenv ]; then
    POWERLEVEL9K_CONTEXT_TEMPLATE=$'%{\e[0;34m%}\uF308 '"$POWERLEVEL9K_CONTEXT_TEMPLATE"
fi
# Optionally, you can also change the color of the Docker icon
# POWERLEVEL9K_CONTEXT_DEFAULT_FOREGROUND=039  # Light blue
